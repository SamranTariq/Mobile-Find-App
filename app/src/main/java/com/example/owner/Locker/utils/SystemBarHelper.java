...
public class SystemBarHelper {
   ...
   * Android4.4
   *
   * @param window 一Activity window,Dialog,DialogFragment
   * @param statusBarColor
   * @param alpha [0.0-1.0]
   */
  ...
  /**
   * Android4.4(DrawerLayout)
   *
   * 1.fitsSystemWindows,DrawerLayout fitsSystemWindows
   *
   * @param activity Activity
  ...
  /**
   * rootView View FitsSystemWindows false
   */
