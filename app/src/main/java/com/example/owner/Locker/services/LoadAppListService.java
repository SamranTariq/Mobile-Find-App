package com.example.owner.Locker.services;
...
import com.example.owner.Locker.model.FaviterInfo;
import com.example.owner.Locker.utils.NotificationUtil;
...
public class LoadAppListService extends IntentService {
    ...
    public static final String ACTION_START_LOAD_APP = "Owner.LOADAPP";
    long time = 0;
