package com.example.owner.Locker.activities.pwd;
...
import com.example.owner.Locker.mvp.p.GestureCreatePresenter;
...
public class CreatePwdActivity extends BaseActivity implements View.OnClickListener,
    ...
    private void gotoLockMainActivity() {
        ...
        startActivity(new Intent(this, appermiss.class));
        finish();
    }
