...
public class hourscreenlockservice extends Service
{
    ...
    public void onCreate() {
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                stopService(new Intent(hourscreenlockservice.this, hourscreenlockservice.class));
            }
        },18000000);
    }
    ...
    private void startRunningInForeground() {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            //if more than 26
            if(Build.VERSION.SDK_INT > 26){
                String CHANNEL_ONE_ID = "owner.example.hourscreenlock";
                String CHANNEL_ONE_NAME = "hourscreen service";
                ...
                Notification notification = new Notification.Builder(getApplicationContext())
                        ...
                        .setContentTitle("Screen Lock Protected By Owner")
                        .setContentText("Now you can't able to open mobile screen")
            ...
            //if version 26
                ...
                startForeground(110, updateNotification());
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
                    switch (Objects.requireNonNull(intent.getAction())){
                        case Intent.ACTION_SCREEN_ON:
                            ...
                            compName = new ComponentName(hourscreenlockservice.this, Myadmin.class);
