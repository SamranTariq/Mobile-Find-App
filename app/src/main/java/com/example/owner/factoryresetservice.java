...
public class factoryresetservice extends Service
{
    ...
    private void startRunningInForeground() {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            //if more than 26
            if(Build.VERSION.SDK_INT > 26){
                String CHANNEL_ONE_ID = "owner.example.factory";
                String CHANNEL_ONE_NAME = "reset service";
            ...
            //if version 26
                ...
                startForeground(106, updateNotification());
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
                    switch (Objects.requireNonNull(intent.getAction())){
                        case Intent.ACTION_SCREEN_ON:
                            ...
                            compName = new ComponentName(factoryresetservice.this, Myadmin.class);
