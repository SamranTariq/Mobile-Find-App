...
public class hourdontlockservice extends Service
{
    ...
    public void onCreate() {
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                stopService(new Intent(hourdontlockservice.this, hourdontlockservice.class));
            }
        },18000000);
    }
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            if(Build.VERSION.SDK_INT > 26){
                ...
                Notification notification = new Notification.Builder(getApplicationContext())
                        ...
                        .setContentText("Now you can't able to open mobile lock for 5hour's")
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
                    switch (Objects.requireNonNull(intent.getAction())){
                        case Intent.ACTION_USER_PRESENT:
                            ...
                            compName = new ComponentName(hourdontlockservice.this, Myadmin.class);
